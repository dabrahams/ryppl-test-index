...
index_template = """<html><head><title>Links for boost-python</title></head><body><h1>Links for %(name)s</h1><a href="git+http://git.%(url_tail)s#egg=%(name)s">Git Repository</a><br/> 
